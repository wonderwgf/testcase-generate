...
- 本文件负责说明 **Agent 如何定位脚本并执行转换**
- 输入 Markdown 应满足的结构、字段和颗粒度规则，统一见 `rules/04-testcase-xmind.mdc`
- 若 `SKILL.md` 与规则文件存在描述差异，以脚本 `scripts/markdown_to_xmind.py` 的真实行为为准，并及时回写文档
